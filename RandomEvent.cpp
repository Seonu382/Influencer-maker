...
void RandomEvent::InitializeDatabase() {
    ...
    liveRandomEvents.push_back(RandomEvent("내가 그냥 재미있게 하려고 했던 건데... 이게 이렇게 심각해질 줄 몰랐네. 사람들이 오해하면 어떡하지... 아, 이걸 어떻게 수습해야 할지 모르겠다. 진짜 고민이다.",
        "사람들이 내 마음을 알아주나봐. 다들 고마워요!", "내가 너무 뻔뻔해 보였나... 반응이 너무 안 좋네..",
        "사람들에게 너무 미안해.. 사과문을 쓰자.", "그래도 재밌으라고 한 건데, 당당히 밝히자!",
        NORMAL, 10,
        2, 0, 0,
        -7, 0, 0));
    liveRandomEvents.push_back(RandomEvent("방송 중에 들어온 미션중인데... 더 진행할지 망설여진다. 이걸 해야 할까, 말아야 할까... 괜히 했다가 실패할까 걱정도 되고... 고민되네.",
        "미션을 결국 실패했어.. 팔로워들에게 미션 실패 공약을 지켜야해..ㅠㅠ", "그래, 이 정도면 충분하지! 그래도 후원은 많이 받았어!",
        "미션을 계속 진행한다", "미션을 그만 진행한다",
        NORMAL, 10,
        10, -10, 0,
        10, 10, 0));
    ...
    liveRandomEvents.push_back(RandomEvent("헉... 도네이션을 받았어... 이거 너무 큰 금액이야",
        "도네이션으로 돈을 벌었어", "그래도 시청자가 주신 돈인데 받는 게 맞을 것 같아.",
        "확인", "거절",
        NORMAL, 10,
        0, 20, 0,
        0, 20, 0));
    ...
    afterRandomEvents.push_back(RandomEvent("팔로워의 선물이 도착했는데, 혼자서 열어볼까 말까 고민하고 있어.",
        ...
        0, 0, 0));
    afterRandomEvents.push_back(RandomEvent("팔로워의 선물이 도착했는데, 혼자서 열어볼까 말까 고민하고 있어.",
        "선물을 열었더니 아무것도 없고 장난을 쳐놨어", "결국 안 열어보기로 결정했어. 고민 끝에, 지금은 그냥 열지 않는 게 나을 것 같다는 생각이 들었거든.",
        "선물을 연다", "선물을 열지 않는다",
        NORMAL, 5,
        0, 0, -2,
        0, 0, 0));
